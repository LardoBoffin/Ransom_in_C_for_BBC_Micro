...
The actual Ransom game code is in the file 'gCode', the other files contain functions to load and save and deal with the counters etc.

I am now adding in the basics of character stats and HPs etc. with a view to adding combat and basic survival (need to eat and drink etc.)
